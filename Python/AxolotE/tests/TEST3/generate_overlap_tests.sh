#!/usr/bin/env bash
#Script to generate unit tests for single-center overlap/orthogonality test.
...
AXOLOTE_DIR="../../."
TEMPLATE_FILE="overlap_template.cpp.in"
OUTPUT_DIR="."
MAIN_RUNNER="${OUTPUT_DIR}/suite_overlap_test.cpp"
...
for L1 in 0 1 2; do
    for L2 in 0 1 2; do
        S1=${SHELL_NAMES[$L1]}
        S2=${SHELL_NAMES[$L2]}
        TEST_FILE="${OUTPUT_DIR}/test_overlap_${S1}_${S2}.cpp"
