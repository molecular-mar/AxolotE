#!/usr/bin/env bash
#Script to generate unit tests for the coordinate inversion parity test.
...
AXOLOTE_DIR="../../."
TEMPLATE_FILE="parity_template.cpp.in"
OUTPUT_DIR="."
MAIN_RUNNER="${OUTPUT_DIR}/suite_parity_test.cpp"
...
int main() {
    std::cout << "========================================\n";
    std::cout << " Running Coordinate Parity Unit Tests  \n";
    std::cout << "========================================\n";
...
for L1 in 0 1 2; do
    for L2 in 0 1 2; do
        S1=${SHELL_NAMES[$L1]}
        S2=${SHELL_NAMES[$L2]}
        TEST_FILE="${OUTPUT_DIR}/test_parity_${S1}_${S2}.cpp"
